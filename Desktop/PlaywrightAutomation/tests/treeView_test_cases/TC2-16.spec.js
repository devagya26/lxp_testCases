...
test("LXP treeView_testCase", async ({ page }) => {
    ...
    await iframe.locator("id=SUBTASKS").click();

    await iframe.locator("id=PARENT").click();
    await iframe.locator("id=SUBTASKS").click();

    await iframe.locator("id=CHILD_ISSUES").click();
    await iframe.locator("id=10000-is blocked by").click();
    await iframe.locator("id=10000-blocks").click();
    ...
    (() => {
      const file1 = fs.readFileSync(
        "/Users/apple/Desktop/PlaywrightAutomation/expectedTC2/TC2-16.json"
      );
