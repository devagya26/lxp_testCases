...
test("LXP treeView_testCase", async ({ page }) => {
    ...
    await iframe.locator("id=2").click(); //high
    await iframe.locator("id=4").click(); //low

    await iframe.locator("id=2").click(); 
    await iframe.locator("id=4").click(); 

    await iframe.locator("id=3").click(); 
    await iframe.locator("id=5").click(); 
    ...
    (() => {
      const file1 = fs.readFileSync(
        "/Users/apple/Desktop/PlaywrightAutomation/expectedTC2/TC2-9.json"
      );
